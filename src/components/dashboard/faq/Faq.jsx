...
import { useGetTermsQuery } from "../../../app/authApi";

const FAQSection = ({ onClose, isOpen }) => {
  const { showFAQ } = useSelector((state) => state.ui);
  const [expandedItems, setExpandedItems] = useState({});

  const { isLoading } = useGetTermsQuery(undefined, {
    skip: !showFAQ,
  });
